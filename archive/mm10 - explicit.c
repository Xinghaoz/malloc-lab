...
#define LEFT_PTR(bp)	((long)GET(LEFT(bp))|(0x800000000))
#define RIGHT_PTR(bp)	((long)GET(RIGHT(bp))|(0x800000000))

#define PUT_LEFT(bp, val)	(PUT(LEFT_ADDR(bp), ((unsigned int)(long)val)))
#define PUT_RIGHT(bp, val)	(PUT(RIGHT_ADDR(bp), ((unsigned int)(long)val)))
  
#define MM_NULL ((void *)0x800000000)	// Set the NULL to be heap bottom

/* Global variables */
static char *heap_listp = 0;  /* Pointer to first block */  
static char *free_list  = MM_NULL; /* Free block list */
